...
private:
	...
	void handleGoalkeeper(const VisualState &visual, int cycle) {
		...
		const double catchReach = fastApproachingShot ? 1.75 : 1.5;
		...
		const bool canAdvance = goalieAdvanceSteps < 2
				&& (!visual.hasOwnGoal || visual.ownGoalDistance <= 6.5);
